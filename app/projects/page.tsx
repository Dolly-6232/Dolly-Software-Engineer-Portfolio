        ...
        <main className="flex min-h-screen w-full max-w-7xl mx-auto py-10 px-6  md:px-16">
          ...
          >
            ...
            <div className="flex-row">
              <a href="https://kickscore.ng/" target="_blank" rel="noopener noreferrer" className={`mr-1 ${theme === 'dark' ? 'text-orange-400 hover:text-orange-300' : 'text-orange-600 hover:text-orange-700'
            ...
            <a href="https://dolly-6232.github.io/aimond-internship-project/" target="_blank" rel="noopener noreferrer" className={`mr-1 ${theme === 'dark' ? 'text-orange-400 hover:text-orange-300' : 'text-orange-600 hover:text-orange-700'
